<?php
     ...
     *	@version	$Id: simple_test.php,v 1.1 2005/12/22 06:40:44 lucholaf Exp $
     */
    ...
    class SimpleTestCase {
        ...
        function &createInvoker() {
            $obj = new SimpleErrorTrappingInvoker(new SimpleInvoker($this));
            return $obj;
        }
        ...
        function &_createRunner(&$reporter) {
            $obj = new SimpleRunner($this, $reporter);
            return $obj;
